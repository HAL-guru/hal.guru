...
Represents the behavior settings for an agent. This class defines the configurable properties that determine how an agent operates during its execution.

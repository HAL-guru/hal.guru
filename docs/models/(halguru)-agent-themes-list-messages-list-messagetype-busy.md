...
Represents a message type indicating that the robot is currently occupied or busy performing a task or operation, signaling it cannot process new requests at the moment.
